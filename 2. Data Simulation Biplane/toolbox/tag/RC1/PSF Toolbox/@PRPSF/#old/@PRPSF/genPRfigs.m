...
switch ImgType
    case 'PSF'
        ...
        h1=[];h2=[];h3=[];h4=[];
        figure('Color',[1,1,1],'Name',' measured and phase retrieved PSF at sampled z positions','Resize','on','Units','normalized','Position',[0.3,0.1,0.72,0.74])
        for ii=1:L
    ...
    case 'pupil'
        ...
        figure('Color',[1,1,1],'Name',' phase retrieved and Zernike fitted pupil function','Resize','on','Units','normalized','Position',[0.3,0.3,0.3,0.56])
        h1=[];
        RC=64;
        Rsub=63;
