...
%% FX test
[CN_phase_complex,phase_complexfit]=obj.Z.fitzernike(pupil_phase,'phase',   Z_N, R);
...
for j=1:N
    ...
    pupil_complex=pupil_magfit.*phase_complexfit.*exp(defocus_phase);
...
obj.PRstruct.Zernike_phase=CN_phase_complex;    %FX
...
obj.PRstruct.Fittedpupil.phase=angle(phase_complexfit);    %FX
