...
R1=obj.PRobjA.PRobj.SubroiSize;
nImm=obj.PRobjA.PRobj.PRstruct.RefractiveIndex;
iterK=obj.PRobjA.PRobj.IterationNumK;
otfsigmax=obj.PRobjA.PRobj.PRstruct.SigmaX;
otfsigmay=obj.PRobjA.PRobj.PRstruct.SigmaY;

x0=[R1,iterK,nImm,otfsigmax,otfsigmay];
x_next=x0;
sigma=[5,1.5,0.005,0.5,0.5];
